...
const SLUG = "hppsc-has-2026";

const NEW_TITLE = "HPPSC HAS 2026: Himachal Pradesh Civil Services Recruit Guide";
const NEW_DESCRIPTION = "HPPSC HAS 2026 fills 158 Himachal Pradesh posts including HAS SDO, HPPS DSP, Tehsildar, and BDO. Apply on hppsc.hp.gov.in by June 14, 2026 for Sept 6 Prelims.";

const NEW_CONTENT = `## HPPSC HAS at a glance
...
1. Open hppsc.hp.gov.in on Chrome, Firefox, or Edge. Older browsers may fail at OTP screens.
2. Click Apply Online next to the HAS 2026 notification.
...
5. Complete the personal details page including caste category, Bona Fide Himachali status, women horizontal reservation claim if applicable, PwBD certification, and mother tongue.
...
**Who is eligible for HPPSC HAS 2026?**
Indian citizens aged 21 to 35 (General category on January 1, 2026) with a Bachelor's degree from a UGC-recognised university and Hindi or Sanskrit at Matriculation level. Note the upper age was reduced from 45 to 35 for 2025 onwards. HP SC / ST candidates get 5 years extra (up to 40), OBC and Sons of Freedom Fighters with HP domicile get 3 years extra, PwBD get 10 years extra.

**How many vacancies are in HPPSC HAS 2026?**
158 vacancies across 6 post categories including Himachal Pradesh Administrative Service (HAS) SDO, Tehsildar, Himachal Pradesh Police Service (HPPS) DSP, Block Development Officer (BDO), Assistant Controller (Finance), and other Group A and B allied posts.

**What is the last date to apply for HPPSC HAS 2026?**
June 14, 2026. Online applications open May 15, 2026 on hppsc.hp.gov.in. The Preliminary Examination is scheduled for September 6, 2026.

**Is Bona Fide Himachali Certificate required for HPPSC HAS?**
Not for base eligibility. Any Indian citizen aged 21 to 35 with a Bachelor's degree can apply. Bona Fide Himachali Certificate is required for SC / ST / OBC reservation, for the 25 percent women horizontal reservation for HP-domicile women, and for extended age relaxations.

**How much is the application fee?**
Rs. 400 for General category and non-Himachali candidates. Rs. 100 for HP SC, ST, OBC, and ex-servicemen. Free for HP PwBD candidates. Payment is online only through Net Banking, UPI, or credit and debit card.

**What is the exam pattern for HPPSC HAS?**
...
**Can I choose Sanskrit as the compulsory language paper?**
Yes. Paper I Compulsory Language accepts either Hindi or Sanskrit at Matriculation level. Native Sanskrit-medium candidates from HP schools score significantly higher on this paper, which is a distinctive advantage over State PSCs where only Hindi is accepted.

**What is the salary of an HPPSC HAS SDO?**
Pay Level 10, basic pay Rs. 56,100 under the Himachal Pradesh Civil Services (Revised Pay) Rules 2022. Gross monthly Rs. 82,000 to Rs. 92,000 including DA at 46 percent, HRA at 24 percent for Shimla and Dharamshala, hard-area allowance for Kinnaur or Lahaul-Spiti postings, and other allowances. In-hand around Rs. 68,000 to Rs. 76,000 after standard deductions.

**Can I become an IAS officer through HPPSC HAS?**
Not directly. HPPSC HAS recruits into Himachal Pradesh state services. IAS deputation is available to a small fraction of HAS officers who clear a Union Public Service Commission promotion process later in their career, typically after 15 to 20 years of state service.

**Should I prepare for HPPSC HAS alongside UPSC Civil Services?**
Yes if you have Bona Fide Himachali status. The syllabus overlap is around 70 percent. Add Paper IX Himachal Pradesh-specific study (2 to 3 hours per day for 2 months), choose an Optional Subject you graduated in, and consider Sanskrit as your Compulsory Language if you have that background. The 1 in 570 selection ratio makes HPPSC one of the more accessible State PSC targets.

## Sources and related pages

- HPPSC official portal: [hppsc.hp.gov.in](https://www.hppsc.hp.gov.in/)
- HPPSC online application: [hppsc.hp.gov.in](https://www.hppsc.hp.gov.in/)
- Himachal Pradesh Government official portal: [himachal.gov.in](https://himachal.gov.in/)
- State of Himachal Pradesh Act 1970 reference: [india.gov.in](https://india.gov.in/)
...
- [HPSC HCS 2026: Haryana Civil Services Recruitment and Prep](https://www.sarkaridarapan.com/sarkari-naukri/hpsc-hcs-2026)
