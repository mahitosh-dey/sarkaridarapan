...
const SLUG = "apsc-cce-2026";

const NEW_TITLE = "APSC CCE 2026: Assam Civil Services Recruitment and Prep";
const NEW_DESCRIPTION = "APSC CCE 2026 fills 277 Assam state services posts including ACS, APS, Finance, and Assistant Commissioner of Taxes. Apply on apsc.nic.in by May 15, 2026.";

const NEW_CONTENT = `## APSC CCE at a glance
...
1. Open apsc.nic.in on Chrome, Firefox, or Edge. Older browsers may fail at the OTP verification screen.
2. Click Apply Online next to the CCE 2026 notification.
...
5. Complete the personal details page including caste category, Assam PRC status, PwBD certification if applicable, and mother tongue.
...
**Who is eligible for APSC CCE 2026?**
...
**How many vacancies are in APSC CCE 2026?**
277 vacancies across 6 post categories including Assam Civil Service (ACS), Assam Police Service (APS), Assam Finance Service, Assistant Commissioner of Taxes, Assam Cooperative Service, and other Group A and B allied posts.

**What is the last date to apply for APSC CCE 2026?**
May 15, 2026. Online applications open April 15, 2026 on apsc.nic.in. The Preliminary Examination is scheduled for August 16, 2026.

**Is Assamese language proficiency mandatory for APSC CCE?**
...
Rs. 250 for General and OBC candidates. Rs. 150 for SC and ST (Plains and Hills) candidates. Free for PwBD and BPL card holders. Payment is online only through Net Banking, UPI, or credit and debit card.

**What is the exam pattern for APSC CCE?**
...
**Can I become an IAS officer through APSC CCE?**
Not directly. APSC CCE recruits into Assam state services. IAS deputation is available to a small fraction of ACS officers who clear a Union Public Service Commission promotion process later in their career, typically after 15 to 20 years of state service.

**Is the Permanent Residence Certificate mandatory?**
Only for reservation benefits. General category applicants from other states can apply without a PRC. OBC, MOBC, SC, and ST candidates must present the Deputy Commissioner-issued PRC at document verification to claim reservation quota posts.

**Should I prepare for APSC CCE alongside UPSC Civil Services?**
Yes if you have Assamese, Bodo, or Assam-recognised language proficiency. The syllabus overlap between APSC CCE and UPSC CSE is around 75 percent. Add Assam-specific General Knowledge (2 hours per day for 2 months) and choose an Optional Subject you graduated in. Many candidates clear APSC as a fallback while continuing UPSC attempts.

## Sources and related pages

- APSC official portal: [apsc.nic.in](https://apsc.nic.in/)
- APSC online application: [apsc.nic.in](https://apsc.nic.in/)
- Assam Government official portal: [assam.gov.in](https://assam.gov.in/)
- Assam State Board of Secondary Education (for language proficiency certificate): [sebaonline.org](https://sebaonline.org/)
