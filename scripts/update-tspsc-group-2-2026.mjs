...
const SLUG = "tspsc-group-2-2026";

const NEW_TITLE = "TSPSC Group 2 2026: Telangana Recruitment and Prep Guide";
const NEW_DESCRIPTION = "TSPSC Group 2 2026 fills 596 Telangana state posts including Deputy Tahsildar, ASO, MDO, and Municipal Commissioner III. Apply on tspsc.gov.in by April 9.";

const NEW_CONTENT = `## TSPSC Group 2 at a glance
...
1. Open tspsc.gov.in on Chrome, Firefox, or Edge. Older browsers may fail at OTP screens.
2. Click One Time Registration (OTR). Every TSPSC applicant needs an OTR profile that remains valid for all future TSPSC exams.
...
5. Complete the personal details page including caste category, Telangana local status, and PwBD certification if applicable.
...
8. Log in to your OTR account, select TSPSC Group 2 2026 from the current notifications, fill the exam-specific form including post preferences in order, and pay the fee.
...
**Who is eligible for TSPSC Group 2 2026?**
Indian citizens aged 18 to 44 (General category on July 1, 2026) with a Bachelor's degree from a UGC-recognised university. BC candidates get 3 years extra (up to 47), SC and ST candidates get 5 years extra (up to 49), PwBD get 10 years extra, and Telangana local status is required for the reserved district-cadre posts.

**How many vacancies are in TSPSC Group 2 2026?**
596 vacancies across 8 post categories including Deputy Tahsildar, Assistant Section Officer at the Telangana Secretariat, Municipal Commissioner Grade III, Mandal Development Officer, Assistant Commercial Tax Officer, Cooperative Sub-Registrar, Deputy Superintendent of Jail, and Extension Officer (Panchayat Raj).

**What is the last date to apply for TSPSC Group 2 2026?**
April 9, 2026. Online applications open March 10, 2026 on tspsc.gov.in. The Prelims Screening Test is scheduled for July 12, 2026.

**Is Telangana local status mandatory for TSPSC Group 2?**
Yes for the reserved district-cadre posts. Local candidature is proved through a Continuous 4-year Study Certificate from Telangana schools or a Nativity Certificate issued by the Mandal Revenue Officer. Non-local candidates can apply for the non-local quota but with limited post availability.

**How much is the application fee?**
Rs. 200 for General and OBC candidates. Free for SC, ST, PwBD, and unemployed Telangana youth (specific eligibility rules apply). Payment is online only through Net Banking, UPI, or credit and debit card.

**What is the exam pattern for TSPSC Group 2?**
Three stages. Prelims is one 150-mark General Studies and Mental Ability paper (qualifying only). Mains is four papers of 150 marks each (Essay and Language, GS I, GS II, Telangana Movement), totalling 600 merit marks. Interview is 75 marks for interview-eligible posts.

**What is Paper IV Telangana Movement about?**
Paper IV covers the Telangana statehood movement from 1948 to 2014 including the Telangana Armed Struggle (1946 to 1951), 1969 Telangana agitation, formation of Telangana Rashtra Samithi (now Bharat Rashtra Samithi), K Chandrashekar Rao's leadership, and state formation on June 2, 2014. Recommended primary sources are K Jayashankar's writings and the Sri Krishna Committee Report 2010.

**What is the salary of a TSPSC Group 2 Deputy Tahsildar?**
Pay Level 15 in Telangana Revised Pay Scales 2020, basic pay Rs. 42,300. Gross monthly Rs. 65,000 to Rs. 75,000 including DA at 33 percent, HRA at 30 percent for Hyderabad, and other allowances. In-hand around Rs. 55,000 to Rs. 62,000 after standard deductions.

**How many attempts can I make for TSPSC Group 2?**
No cap on total attempts. Only the upper age limit (44 for General, 47 for BC, 49 for SC and ST) applies. You can appear as many times as the age ceiling allows.

**Should I prepare for TSPSC Group 2 alongside APPSC Group 2?**
Yes if you have Telugu-medium schooling. TSPSC Group 2 and APPSC Group 2 syllabi overlap by around 70 percent, and the Paper IV differs (Telangana Movement vs Andhra Pradesh state history). Shared preparation is efficient, and clearing Prelims for one or both provides fallback options. Candidates with local status in only one state should prioritise that state's exam.

## Sources and related pages

- TSPSC official portal: [tspsc.gov.in](https://tspsc.gov.in/)
- TSPSC OTR registration: [tspsc.gov.in](https://tspsc.gov.in/)
- Telangana Government official portal: [telangana.gov.in](https://telangana.gov.in/)
- Sri Krishna Committee Report 2010 reference: [mha.gov.in](https://mha.gov.in/)
- Union Public Service Commission (for UPSC CSE comparison): [upsc.gov.in](https://upsc.gov.in)

Related pages on this site:

- [APPSC Group 2 2026: Andhra Pradesh Recruitment and Prep Guide](https://www.sarkaridarapan.com/sarkari-naukri/appsc-group-2-2026)
