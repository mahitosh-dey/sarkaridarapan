...
export default function SchemeDetail({ scheme }: SchemeDetailProps) {
  ...
  return (
    <article className="mx-auto max-w-4xl">
      ...
      {/* Schemes have no Quick Information table, so the attribution opens the
          content body. officialPortal is populated on all 58 live schemes. */}
      <SourceAttribution
        sourceUrl={scheme.officialPortal}
