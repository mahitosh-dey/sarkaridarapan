...
export const metadata: Metadata = {
  ...
  description:
    "Check latest Sarkari Result 2025. Get government exam results for SSC, UPSC, Railway, Banking, State PSC, and other competitive exams. Direct links to official result pages.",
  alternates: {
    canonical: `${SITE_URL}/results`,
  },
  openGraph: {
    title: `Sarkari Result 2025 - Latest Government Exam Results | ${SITE_NAME}`,
    description:
      "Check latest Sarkari Result 2025. Direct links to official government exam result pages.",
