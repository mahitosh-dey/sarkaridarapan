...
const results = [
  ...
  {
    id: 8,
    examName: "Rajasthan PTET Result 2026",
  ...
  {
    id: 9,
    examName: "CA Intermediate May 2026 Result",
  ...
  {
    id: 10,
    examName: "UPSC NDA 1 Written Result 2026",
  ...
  {
    id: 11,
    examName: "MPSC Rajyaseva Prelims Result 2026",
    organization: "Maharashtra Public Service Commission (MPSC)",
    resultDate: "2026-06-22",
    status: "Declared",
    officialLink: "https://mpsc.gov.in",
    totalCandidates: "4,103 qualified for Mains",
  },
  {
    id: 12,
    examName: "MPPSC State Service Prelims Result 2026",
