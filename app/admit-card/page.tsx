...
export const metadata: Metadata = {
  title: "Admit Card 2025 - Download Government Exam Hall Tickets",
  description:
    "Download latest admit cards and hall tickets for government exams 2025. Get direct links to download admit cards for SSC, UPSC, Railway, Banking, Defence, and state-level exams.",
  alternates: {
    canonical: `${SITE_URL}/admit-card`,
  },
  openGraph: {
    title: `Admit Card 2025 - Download Government Exam Hall Tickets | ${SITE_NAME}`,
    description:
      "Download latest admit cards and hall tickets for government exams 2025.",
...
const sampleAdmitCards = [
  {
    id: 1,
    examName: "SSC CGL 2025 Tier-I Admit Card",
  ...
  {
    id: 2,
    examName: "UPSC CSE 2025 Prelims Admit Card",
    organization: "Union Public Service Commission",
    examDate: "2025-06-01",
    downloadDate: "2025-05-15",
    status: "Upcoming",
    officialLink: "https://upsc.gov.in",
  },
  {
    id: 3,
    examName: "RRB Group D 2025 CBT Admit Card",
    organization: "Railway Recruitment Board",
    examDate: "2025-02-20",
    downloadDate: "2025-02-05",
    status: "Available",
    officialLink: "https://rrbcdg.gov.in",
  },
  {
    id: 4,
    examName: "IBPS Clerk Mains 2025 Admit Card",
    organization: "Institute of Banking Personnel Selection",
    examDate: "2025-02-25",
    downloadDate: "2025-02-10",
    status: "Available",
    officialLink: "https://ibps.in",
  },
  {
    id: 5,
    examName: "NTA CUET UG 2025 Admit Card",
    organization: "National Testing Agency",
    examDate: "2025-05-15",
    downloadDate: "2025-05-01",
    status: "Upcoming",
    officialLink: "https://cuet.samarth.ac.in",
  },
  {
    id: 6,
    examName: "UPPSC PCS 2025 Prelims Admit Card",
  ...
  {
    id: 7,
    examName: "SSC CHSL 2025 Tier-I Admit Card",
    organization: "Staff Selection Commission",
    examDate: "2025-03-10",
    downloadDate: "2025-02-25",
    status: "Available",
    officialLink: "https://ssc.nic.in",
  },
  {
    id: 8,
    examName: "Indian Army Agniveer 2025 Admit Card",
    organization: "Indian Army",
    examDate: "2025-03-15",
    downloadDate: "2025-03-01",
    status: "Upcoming",
